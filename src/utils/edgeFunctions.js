...
export const edgeFunctionHelpers = {
  ...
  orders: {
    ...
    update: (id, items, upsellingDiscountAmount = 0, discountCodeId = null, customerName = null, customerEmail = null) => callEdgeFunction('orders', {
      method: 'POST',
      body: { action: 'update', id, items, upsellingDiscountAmount, discountCodeId, customerName, customerEmail },
    }),
